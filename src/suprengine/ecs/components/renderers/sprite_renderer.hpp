...
namespace suprengine
{
	...
	public:
		...
		SpriteRenderer( Entity* owner, Texture* texture, Color modulate = Color::white, int priority_order = 0 )
			: texture( texture ), dest( dest ), Renderer( owner, modulate, priority_order ) 
		{
